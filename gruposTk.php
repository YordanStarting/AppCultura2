      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="details">
            ...
            <p>- <?php echo $evento["gruposDesc"] ?></p>
              <p>
              <h5>
                <b>GRUPOS DE 4 A 10 </b><br> Valor por persona: <br>
                <b> $ <?php echo $newValor2; ?></b>
                </p>
                <div class="col-sm-2">
                ...
                <input type="hidden" name="disp" value="<?php echo $evento["gruposDisp"]; ?>">
                <input type="hidden" name="cat" value="gruposDisp">
                <input type="hidden" name="valor" value="<?php echo $evento["gruposValor"]; ?>">
