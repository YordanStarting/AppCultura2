...
?>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
      <h1 class="mb-4 pb-0">Eventos <br><span>Parlo <br></span>Colombia pura</h1>
      <p class="mb-4 pb-0">10-12 December, Downtown Conference Center, New York</p>
      <a href="https://www.youtube.com/watch?v=jDDaplaOz7Q" class="glightbox play-btn mb-4"></a>
      <a href="#about" class="about-btn scrollto">Sobre los Eventos</a>
    </div>
  ...
  <main id="main">
    ...
    <section id="schedule" class="section-with-bg">
      <?php require_once 'App/dashboard/modelos/conexion.php'; ?>
      <div class="container" data-aos="fade-up">
    ...
    <section id="venue">
      ...
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row g-5 gy-5">
          ...
          require_once "App/dashboard/controladores/eventos.controlador.php";
          require_once "App/dashboard/modelos/eventos.modelo.php";
          ...
          ?>
            <div class="col-md-4">
              <div class="card">
                ...
                <div class="card-body">
                <center>
                  <h5 class="card-title"><b><?php echo $value["nombreEvento"] ?></b></h5>
        ...
        <center>
        <a href="eventosAct.php" class="btn btn-outline-danger btn-md">Ver todos los eventos</a>
          </center>
    ...
    <section id="gallery">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-header">
          <h2>BARES</h2>
          <p>Dale un vistazo a la galeria de los mejores bares</p>
        </div>
      </div>
