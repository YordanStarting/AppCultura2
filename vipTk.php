      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="details">
            ...
            <p>- <?php echo $evento["vipDesc"] ?></p>
              <p>
              <h5>
                <b>VIP DE 4 A 10 </b><br> Valor por persona: <br>
                <b> $ <?php echo $newValor3; ?></b>
                </p>
                <div class="col-sm-2">
                ...
                <input type="hidden" name="disp" value="<?php echo $evento["vipDisp"]; ?>">
                <input type="hidden" name="cat" value="vipDisp">
                <input type="hidden" name="valor" value="<?php echo $evento["vipValor"]; ?>">
